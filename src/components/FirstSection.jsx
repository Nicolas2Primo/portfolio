  ...
  return (
    <div className="flex items-center justify-center w-full h-screen px-4 background-gradient">
      <div className="flex flex-col items-center md:items-start w-fit h-fit">
        <span className="flex span-animation border-r-[2px] md:border-r-[4px] w-[19.5ch] md:w-[18ch] whitespace-nowrap overflow-hidden border-solid items-center gap-1 font-black text-[#917CAA] text-[10px] md:text-lg font-titillium">
