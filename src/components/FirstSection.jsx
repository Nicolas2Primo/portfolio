    ...
    <div className="flex items-center justify-center w-full h-full">
      <div className="flex flex-col items-center md:items-start w-fit h-fit">
        ...
        <div className="flex items-center justify-center w-full mt-2 text-center md:mt-3 md:justify-end md:text-start md:pr-12 h-fit">
          <span className=" text-[10px] w-[250px] md:w-[410px] md:text-[12px] text-white font-titillium md:indent-12 leading-4 md:leading-5">
        ...
        <div className="flex gap-4 mt-4 md:hidden">
          <AiFillLinkedin
            size={28}
            color="#FEE6C2"
            className="hover:translate-y-[-5px] hover:duration-300 hover:transition-transform focus:scale-125 "
          />
          <AiFillGithub
            size={28}
            color="#FEE6C2"
